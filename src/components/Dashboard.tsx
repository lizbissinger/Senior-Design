            ...
            <div className="relative flex h-16 items-center justify-between">
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <h1 className="h-8 w-auto select-none ml-1 mb-3">
                    <a href="/dashboard/overview" className="no-underline text-neutral-900 hover:text-neutral-900 hover:no-underline">
                      FLEETWAVE
                    </a>
                  </h1>
                </div>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? 'bg-[#6686DC] text-neutral-950 no-underline' : 'no-underline text-neutral-950 hover:bg-[#6686DC] hover:text-neutral-950 hover:no-underline',
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="relative ml-3">
                  <div>
                    <Menu.Button className="relative flex rounded-full bg-[#7392e9] text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-indigo-900">
                      <span className="absolute -inset-1.5" />
